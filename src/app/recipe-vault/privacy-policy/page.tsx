...
export const metadata: Metadata = {
  ...
  description: 'Privacy Policy of Recipe Vault',
};

const getPrivacyPolicyContent = async (): Promise<string> => {
  const markdownFilePath = path.join(process.cwd(), 'public', 'recipe-vault', 'privacy-policy.md');
  ...
  const processedContent = await unified()
    ...
    .use(remarkRehype)
    .use(rehypeStringify)
    .process(await read('public/recipe-vault/privacy-policy.md'));
